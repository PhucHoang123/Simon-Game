...
* to player actions.
*
* @brief Creative aspect "Confetti Celebration": so this will use QPropertyAnimation
* or QGraphicsView to animate small shapes that move from the top of the window
* to the bottom or just burst for a moment.
*/
#include "view.h"
#include "ui_view.h"
